...
exports.stationSlotTrans = exports.noIconBuildings = exports.buildingMeta = void 0;
const three_1 = require("three");
// 'box' from selectSize in SlotConfig
// 'offset' from selectCenter in SlotConfig
const buildingMetaRaw = ([
...
exports.buildingMeta = new Map();
for (const [id, d] of buildingMetaRaw) {
    const unitBoxTrans = new three_1.Matrix4();
    const iconTrans = new three_1.Matrix4();
    ...
    exports.buildingMeta.set(id, {
        color: new three_1.Color(d.color ?? 0xdddddd),
        unitBoxTrans,
        selectUnitBoxTrans,
        iconTrans,
    });
}
exports.noIconBuildings = new Set([
    2020, // 四向分流器
    2040, // 自动集装机
    2030, // 流速监测器
    2313, // 喷涂机
...
exports.stationSlotTrans = (function () {
    ...
    return slots.map(s => new three_1.Matrix4().makeTranslation(s[0], s[1], 0.));
})();
